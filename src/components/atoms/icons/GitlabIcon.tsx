...
function GitlabIcon(props: SvgIconProps, ref: ForwardedRef<SVGSVGElement>) {
  return (
    <SvgIcon
      {...props}
      width="20"
      height="20"
      viewBox="85 90 210 200"
      fill="none"
      ref={ref}
    >
      <g id="LOGO">
...
export default React.memo(React.forwardRef<SVGSVGElement>(GitlabIcon));
